...
# Test Case 1: "cbc"
message_1 = b"cbc"
hash_1 = sha512_hash(message_1)
print(f"Input: \"cbc\"")
# Expected SHA-512:  531668966ee79b70 0b8e593261101354 4273f7ef7b31f279 2a7ef68d53f93264 319c165ad96d9187 55e6a204c2607e27 6e05cdf993a64c85 ef9e1e125c0f925f
print(f"Hash: {hash_1}\n")

# Test Case 2: "abc"
message_2 = b"abc"
hash_2 = sha512_hash(message_2)
print(f"Input: \"abc\"")
# Expected SHA-512: ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f
print(f"Hash: {hash_2}")